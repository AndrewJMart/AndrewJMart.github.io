...
<div class="about-container">
    ...
    <div class="publications-grid">
        <a href="/assets/pdfs/papers/ConcurrentBoiling.pdf" class="publication-box" target="_blank" rel="noopener noreferrer">
            <h3 class="box-title">Influence of Concurrent Boiling Events on Acoustic Nucleation Rhythms</h3>
        ...
        <a href="https://ntrs.nasa.gov/citations/20250011359" class="publication-box" target="_blank" rel="noopener noreferrer">
            <h3 class="box-title">Interpretable Machine Learning for Acoustic Classification of Incipient Boiling Regimes</h3>
            <p class="box-description">
    ...
    <div class="projects-grid">
        ...
        <a href="https://compdoku.com" class="project-box" target="_blank" rel="noopener noreferrer">
            <h3 class="box-title">Competitive Sudoku</h3>
            <p class="box-description">
